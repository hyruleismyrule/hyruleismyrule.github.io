...
fetch(standardURL)
    ...
    .then(function (jsonObject) {
        const standardSP = jsonObject['standardSP'];
        // console.table(jsonObject);
        // console.log(standardSP);

        const standardKingSSR = jsonObject['standardKingSSR'];
        // console.log(standardKingSSR);

        const standardSSR = jsonObject['standardSSR'];
        // console.log(standardSSR);

        const standardKingSR = jsonObject['standardKingSR'];
        // console.log(standardKingSR);

        const standardSR = jsonObject['standardSR'];
        // console.log(standardSR);

        const standardKingR = jsonObject['standardKingR'];
        // console.log(standardKingR);

        const standardR = jsonObject['standardR'];
...
function displayResults() {
    ...
    karmas = [
        ["SP", "Lucien", "Law of Gravity", "Execution", false],
        ["SP", "Victor", "Only Tonight", "Decision", false],
        ["SP", "Gavin", "Dream Traveler", "Creativity", false],
        ["SP", "Kiro", "Gorgeous Lights", "Creativity", false],
        ["SSR", "Lucien", "Memory Lapse", "Decision", true],
        ["SSR", "Lucien", "Drowning in Love", "Creativity", false],
        ["SSR", "Lucien", "Sound of Silence", "Execution", false],
        ["SSR", "Lucien", "Autumn Whisper", "Affinity", false],
        ["SSR", "Victor", "Music of the Night", "Execution", false],
        ["SSR", "Victor", "Loving Stare", "Creativity", true]
    ]
    ...
    // karma, displayedKarma, karmas


    // for (let displayedKarma = 0; displayedKarma < 10; displayedKarma++) {
    //     displayKarma(karmas[displayedKarma], displayedKarma);
    // }

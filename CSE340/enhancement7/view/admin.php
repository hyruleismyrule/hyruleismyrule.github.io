  ...
  <body>
    <div class="all-content-wrapper">
      ...
      <main>
        ...
        <h2 class="mobile-margin">Account Management</h2>
        <p class="mobile-margin">Use this link to update the account information.</p>
        <a class="mobile-margin" href="/phpmotors/accounts?action=toUpdateAccount">Update Account Information</a>
        

        <?php
        if ($_SESSION['clientData']['clientLevel'] > 1) {
          echo '<h2 class="mobile-margin" >Inventory Management</h2>';
          echo '<p class="mobile-margin" >Use this link to manage the inventory.</p>';
          echo '<a class="mobile-margin" href="/phpmotors/vehicles">Add Vehicle or Classification</a>';
        }
        ?>

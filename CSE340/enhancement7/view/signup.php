            ...
            <div class="form">
                <form action="/phpmotors/accounts/index.php" method="post">
                    <fieldset>
                        ...
                        <label>First name*:
                            <input type="text" name="clientFirstname" id="clientFirstname" pattern="[A-Za-z]{3,}" required placeholder="John" <?php if(isset($clientFirstname)){echo "value='$clientFirstname'";}  ?>>
                        </label>
                        <label>Last name*:
                            <input type="text" name="clientLastname" id="clientLastname" pattern="[A-Za-z]{3,}" required placeholder="Doe" <?php if(isset($clientLastname)){echo "value='$clientLastname'";}  ?>>
                        </label>
                    </fieldset>
                    <fieldset>
                        <legend>Login Information</legend>
                        <label>Email*:
                            <input type="email" name="clientEmail" id="clientEmail" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" required placeholder="sample@gmail.com" <?php if(isset($clientEmail)){echo "value='$clientEmail'";}  ?>>
                        </label>
                        <label>Password*:

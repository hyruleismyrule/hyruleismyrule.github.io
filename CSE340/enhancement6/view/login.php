        ...
        <main>
            ...
            <div class="form">
                ...
                <form method="post" action="/phpmotors/accounts/">
                    ...
                    <input type="hidden" name="action" value="startlogin">
                    <button type="submit">Login</button>
                </form>
            </div>
            <div class="mobile-margin">
                <h2>No account? <a href="/phpmotors/accounts?action=signup" title="Login or Register with PHP Motors" id="accSU">Sign Up</a></h2>
            </div>

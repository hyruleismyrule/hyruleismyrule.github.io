<?php
    ...
    // Checks to see if user is logged in and if level is less than 2
    if (empty($cookieFirstname)) {
...
<body>
    <div class="all-content-wrapper">
        ...
        <main>
            ...
            <div class="mobile-margin">
                    <ul>
                        <li><a href="/phpmotors/vehicles?action=toClassification">Add Classification</a></li>
                        <li><a href="/phpmotors/vehicles?action=toVehicles">Add Vehicle</a></li>
                    </ul>
            </div>
